...
%      applied to the GUI before home_OpeningFunction gets called.  An
...
% Last Modified by GUIDE v2.5 27-Sep-2010 12:31:52
...
S = imread('picture2.jpg');
axes(handles.axes1);
imshow(S);

T = imread('picture3.jpg');
axes(handles.axes3);
imshow(T);
...
background = imread('C:\Matlab\MatLab\work\UCR\Penguins.jpg');
